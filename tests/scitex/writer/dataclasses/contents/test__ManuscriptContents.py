#!/usr/bin/env python3
"""Tests for scitex.writer._dataclasses.contents._ManuscriptContents."""

from pathlib import Path

import pytest

from scitex.writer._dataclasses.contents._ManuscriptContents import ManuscriptContents
