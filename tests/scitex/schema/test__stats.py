...
class TestBackwardCompatibility:
    ...
    def test_type_aliases_reexported(self):
        ...
        from scitex.schema._stats import PositionMode, SymbolStyle, UnitType
        from scitex.stats._schema import PositionMode as PM2
        from scitex.stats._schema import SymbolStyle as SS2
        from scitex.stats._schema import UnitType as UT2
...
class TestStatPositioning:
    ...
    def test_with_position(self):
        ...
        from scitex.schema import Position, StatPositioning
...
class TestStatResult:
    ...
    def test_auto_creates_positioning(self):
        ...
        from scitex.schema import StatPositioning, StatResult
