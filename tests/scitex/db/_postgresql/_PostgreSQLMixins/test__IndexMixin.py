...
class TestCreateIndex(TestIndexMixin):
    ...
    def test_create_index_long_name(self):
        ...
        long_columns = [
            "extremely_long_column_name_one",
            "extremely_long_column_name_two",
        ]
...
class TestIndexMixinIntegration:
    ...
    def test_create_and_drop_workflow(self):
        ...
        mock_result = Mock()
        mock_result.fetchall.return_value = [{"indexname": "idx_users_email_username"}]
    ...
    def test_multiple_indexes_on_same_table(self):
        ...
        mixin.create_index(
            "orders", ["status", "created_at"], index_name="idx_orders_status_date"
        )
