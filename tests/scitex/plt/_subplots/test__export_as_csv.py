...
# Try direct import
try:
    from scitex.plt._subplots import _format_imshow2d, export_as_csv, format_record
except ImportError:
    # Skip tests if module not properly available
    pytest.skip(
        "Module scitex.plt._subplots._export_as_csv not available",
...
class TestFormatRecord:
    ...
    def test_plot_with_xarray(self):
        ...
        y_xr = xr.DataArray([[4, 7], [5, 8], [6, 9]], dims=["x", "y"])
    ...
    def test_sns_boxplot(self):
        ...
        df = pd.DataFrame({"group1": [1, 2, 3, 4], "group2": [5, 6, 7, 8]})
...
class TestEdgeCases:
    ...
    def test_unicode_in_labels(self):
        ...
        history = {"plot1": ("plot1", "bar", (["α", "β", "γ"], [1, 2, 3]), {})}
        result = export_as_csv(history)
        assert isinstance(result, pd.DataFrame)
    ...
    def test_very_long_ids(self):
        ...
        long_id = "a" * 100
        history = {long_id: (long_id, "plot", ([1, 2], [3, 4]), {})}
        result = export_as_csv(history)
        assert isinstance(result, pd.DataFrame)
    ...
    def test_special_characters_in_id(self):
        ...
        history = {special_id: (special_id, "plot", ([1, 2], [3, 4]), {})}
        result = export_as_csv(history)
        assert isinstance(result, pd.DataFrame)
...
class TestWarningSystem:
    ...
    def test_helpful_warning_for_imshow(self):
        ...
        history = {"img1": ("img1", "imshow", {"args": (np.random.rand(10, 10),)}, {})}
    ...
    def test_helpful_warning_for_unknown_method(self):
        ...
        history = {"unknown1": ("unknown1", "custom_plot", {"args": ([1, 2, 3],)}, {})}
...
class TestPlotImshowExport:
    ...
    def test_plot_imshow_basic_export(self):
        ...
        history = {"img1": ("img1", "plot_imshow", {"imshow_df": df}, {})}
    ...
    def test_plot_imshow_with_none_id(self):
        ...
        history = {None: (None, "plot_imshow", {"imshow_df": df}, {})}
