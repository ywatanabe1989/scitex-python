...
class TestFormatPlot:
    ...
    def test_id_prefix_applied_correctly(self):
        ...
        When a non-standard ID is given, _parse_tracking_id defaults to
        ax_row=0, ax_col=0, trace_index=0, so get_csv_column_name produces
        columns starting with 'ax_00_plot_0_'.
        """
        x = np.array([1.0, 2.0])
        y = np.array([3.0, 4.0])
        tracked_dict = {"args": (x, y)}
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /home/ywatanabe/proj/scitex-code/src/scitex/plt/_subplots/_export_as_csv_formatters/_format_plot.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /home/ywatanabe/proj/scitex-code/src/scitex/plt/_subplots/_export_as_csv_formatters/_format_plot.py
# --------------------------------------------------------------------------------
