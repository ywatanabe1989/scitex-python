...
class TestShowSpines:
    ...
    def test_show_selective_spines(self):
        ...
        scitex.plt.ax.show_spines(
            self.ax, top=False, right=False, bottom=True, left=True
        )
    ...
    def test_tick_positioning_bottom_only(self):
        ...
        scitex.plt.ax.show_spines(
            self.ax, top=False, bottom=True, left=False, right=False
        )
    ...
    def test_tick_positioning_top_only(self):
        ...
        scitex.plt.ax.show_spines(
            self.ax, top=True, bottom=False, left=False, right=False
        )
    ...
    def test_tick_positioning_both_horizontal(self):
        ...
        scitex.plt.ax.show_spines(
            self.ax, top=True, bottom=True, left=False, right=False
        )
    ...
    def test_tick_positioning_left_only(self):
        ...
        scitex.plt.ax.show_spines(
            self.ax, top=False, bottom=False, left=True, right=False
        )
    ...
    def test_tick_positioning_right_only(self):
        ...
        scitex.plt.ax.show_spines(
            self.ax, top=False, bottom=False, left=False, right=True
        )
    ...
    def test_tick_positioning_both_vertical(self):
        ...
        scitex.plt.ax.show_spines(
            self.ax, top=False, bottom=False, left=True, right=True
        )
...
class TestScitexAxisWrapperCompatibility:
    ...
    def test_invalid_axis_type(self):
        ...
        with pytest.raises(
            AssertionError, match="First argument must be a matplotlib axis"
        ):
...
class TestToggleSpines:
    ...
    def test_toggle_all_spines(self):
        ...
        initial_states = {
            name: spine.get_visible() for name, spine in self.ax.spines.items()
        }
...
class TestIntegration:
    ...
    def test_scientific_plot_workflow(self):
        ...
        scitex.plt.ax.show_classic_spines(self.ax, spine_width=1.2, spine_color="black")
    ...
    def test_publication_ready_workflow(self):
        ...
        scitex.plt.ax.show_box_spines(
            self.ax, spine_width=0.8, spine_color="#333333", ticks=True, labels=True
        )
