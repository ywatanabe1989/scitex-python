...
from scitex.plt.ax._style import export_metadata_yaml, set_figure_meta, set_meta
...
class TestSetMeta:
    ...
    def test_set_meta_additional_kwargs(self, setup_figure):
        ...
        set_meta(ax, caption="Test", custom_field="custom_value", another_field=42)
    ...
    def test_set_meta_none_values_ignored(self, setup_figure):
        ...
        set_meta(ax, caption="Test", methods=None, stats=None)
...
class TestSetFigureMeta:
    ...
    def test_set_figure_meta_basic(self, setup_figure):
        ...
        result = set_figure_meta(
            ax, caption="Main figure caption", significance="Important findings"
        )
    ...
    def test_set_figure_meta_additional_fields(self, setup_figure):
        ...
        set_figure_meta(ax, caption="Test", custom_field="value", numeric_field=42)
...
class TestExportMetadataYaml:
    ...
    def setup_figure_with_metadata(self):
        ...
        set_meta(ax2, caption="Panel 2 caption", experimental_details={"samples": 50})
...
class TestIntegration:
    ...
    def test_complete_workflow(self):
        ...
        try:
            ...
            assert (
                data["figure_metadata"]["main_caption"]
                == "Complete multi-panel analysis"
            )
