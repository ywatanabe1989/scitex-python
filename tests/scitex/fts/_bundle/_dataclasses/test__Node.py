...
class TestNodeCreation:
    ...
    def test_create_minimal_node(self):
        ...
        from scitex.fts._bundle._dataclasses import Node
    ...
    def test_create_with_size_mm(self):
        ...
        from scitex.fts._bundle._dataclasses import Node, SizeMM
...
class TestNodeBBox:
    ...
    def test_custom_bbox(self):
        ...
        from scitex.fts._bundle._dataclasses import Node, BBox
