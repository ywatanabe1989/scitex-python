...
class TestFormatStatsForLatex:
    ...
    def test_format_t_test(self):
        ...
        from scitex.fts._tables._latex._stats_formatter import format_stats_for_latex
...
class TestFormatInlineStat:
    ...
    def test_inline_t_test(self):
        ...
        from scitex.fts._tables._latex._stats_formatter import format_inline_stat
...
class TestFormatStatNote:
    ...
    def test_note_with_stars(self):
        ...
        from scitex.fts._tables._latex._stats_formatter import FormattedStat, format_stat_note
...
class TestFormatStatsParagraph:
    ...
    def test_paragraph_generation(self):
        ...
        from scitex.fts._tables._latex._stats_formatter import (
            FormattedStat,
    ...
    def test_empty_paragraph(self):
        ...
        from scitex.fts._tables._latex._stats_formatter import format_stats_paragraph
...
class TestTestTypeLabels:
    ...
    def test_t_test_label(self):
        """Test t-test label."""
        from scitex.fts._tables._latex._stats_formatter import _get_test_type_label
