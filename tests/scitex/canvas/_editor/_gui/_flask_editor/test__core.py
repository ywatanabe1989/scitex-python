...
# --------------------------------------------------------------------------------
# Start of Source Code from: /home/ywatanabe/proj/scitex-code/src/scitex/fts/_fig/_editor/_gui/_flask_editor/_core.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
...
#                 if bundle_path
#                 else (
#                     Path(figure_dir).stem.replace(".figure", "") if figure_dir else "figure"
#                 )
#             )
#
...
#                                         preview_path = preview_path.split(".plot/")[
#                                             -1
#                                         ]
...
#                                     os.unlink(tmp_path)
#                             except Exception as e:
#                                 print(f"Could not load pltz {plot_path}: {e}")
#                                 continue
#
#                     exported = {}
#
...
# --------------------------------------------------------------------------------
# End of Source Code from: /home/ywatanabe/proj/scitex-code/src/scitex/fts/_fig/_editor/_gui/_flask_editor/_core.py
# --------------------------------------------------------------------------------
