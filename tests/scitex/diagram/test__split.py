...
pytest.importorskip(
    "scitex.diagram._split", reason="scitex.diagram._split module not available"
)

from scitex.diagram._schema import DiagramSpec, EdgeSpec, NodeSpec  # noqa: E402
from scitex.diagram._split import (  # noqa: E402
    SplitConfig,
    SplitResult,
    SplitStrategy,
    _split_by_articulation,
    _split_by_groups,
    split_diagram,
)
...
class TestSplitConfig:
    ...
    def test_custom_config(self):
        config = SplitConfig(
            enabled=True, max_nodes=5, strategy=SplitStrategy.BY_ARTICULATION
        )
