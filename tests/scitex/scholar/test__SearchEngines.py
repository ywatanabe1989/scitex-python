...
class TestSemanticScholarEngine:
    ...
    async def test_search_basic(self):
        ...
        with patch('aiohttp.ClientSession') as mock_session_class:
            ...
            papers = await engine.search_async("test query", limit=10)
    ...
    async def test_search_by_corpus_id(self):
        ...
        with patch.object(engine, '_fetch_paper_by_id_async') as mock_fetch:
            mock_fetch.return_value = engine._parse_semantic_scholar_paper(mock_paper_data)
            
            papers = await engine.search_async("CorpusId:123456")
    ...
    async def test_search_with_year_filters(self):
        ...
        with patch('aiohttp.ClientSession') as mock_session_class:
            ...
            await engine.search_async("test", year_min=2020, year_max=2023)
...
class TestLocalSearchEngine:
    ...
    async def test_search_basic(self, temp_index):
        ...
        papers = await engine.search_async("machine learning", limit=10)
...
class TestVectorSearchEngine:
    ...
    async def test_search_without_model(self):
        ...
        papers = await engine.search_async("test query")
        assert papers == []
