...
class TestScholar:
    ...
    def test_search(self, scholar):
        ...
        with patch.object(scholar._searcher, 'search_async', 
    ...
    def test_search_local(self, scholar, tmp_path):
        ...
        with patch.object(scholar._searcher, 'search_async', side_effect=mock_search):
...
"""
    ...
    def test_download_pdfs(self, scholar, tmp_path):
        ...
        with patch.object(scholar._pdf_downloader, 'batch_download_async', mock_batch_download):
    ...
    def test_search_returns_papers(self, scholar):
        ...
        with patch.object(scholar._searcher, 'search_async', return_value=mock_papers):
...
class TestScholarIntegration:
    ...
    def test_full_workflow(self, tmp_path):
        ...
        with patch.object(scholar._searcher, 'search_async', return_value=mock_papers):
            ...
            with patch.object(scholar._pdf_downloader, 'batch_download_async', mock_download):
