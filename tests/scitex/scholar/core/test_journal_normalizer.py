...
pytest.importorskip("scitex.scholar.core.journal_normalizer")

try:
    from scitex.scholar.core.journal_normalizer import (  # noqa: F401
        JournalNormalizer,
        _normalize_issn,
        _normalize_name,
    ...
    pytest.skip(
        "scitex.scholar.core.journal_normalizer not available", allow_module_level=True
    )
