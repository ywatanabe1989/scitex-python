...
class TestGetSource:
    ...
    def test_get_source_success(self):
        ...
        result = get_source("scitex.introspect._resolve.resolve_object")
    ...
    def test_source_max_lines(self):
        """Test max_lines limits output."""
        from scitex.introspect import get_source

        result = get_source("scitex.introspect._resolve.resolve_object", max_lines=5)
        assert result["success"] is True
    ...
    def test_source_builtin_fails(self):
        """Test getting source of builtin fails gracefully."""
        from scitex.introspect import get_source

        result = get_source("len")
    ...
    def test_source_class(self):
        ...
        result = get_source("pathlib.PurePath")
        assert result["success"] is True
    ...
    def test_source_invalid_path(self):
        ...
        result = get_source("nonexistent.module")
        assert result["success"] is False
