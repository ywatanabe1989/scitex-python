...
class TestDeprecated:
    ...
    def test_deprecated_basic_functionality(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert "old_function is deprecated: This function is old" in str(
                w[0].message
            )
    ...
    def test_deprecated_very_long_reason(self):
        ...
        long_reason = (
            "This is a very long deprecation reason that explains in great detail why this function is deprecated and what alternatives should be used instead. "
            * 10
        )
    ...
    def test_deprecated_special_characters_in_reason(self):
        ...
        special_reason = (
            "Function deprecated! Use new_func() -> str | None instead. Cost: $0.00"
        )
