...
def demo_visual_metadata_with_qr():
    ...
    ax_qr = plt.subplot2grid((10, 10), (8, 0), rowspan=2, colspan=3)
    ...
    ax_qr.axis('off')
    ax_qr.set_title('Scan for metadata', fontsize=9, pad=5)

    # Metadata display area (bottom middle)
    ax_meta = plt.subplot2grid((10, 10), (8, 3), rowspan=2, colspan=5)
    ...
    if LOGO_PATH.exists():
        ...
        ax_logo.text(0.5, 0.5, 'Generated by\nSciTeX\nscitex.ai',
