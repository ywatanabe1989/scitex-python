...
# File: /home/ywatanabe/proj/scitex-code/examples/demo_scitex_wrappers/_13_plot_errorbar.py

"""ax.plot_errorbar(x, y, yerr) - Error bar wrapper."""

import numpy as np


def demo_plot_errorbar(fig, ax, stx):
    """ax.plot_errorbar(x, y, yerr) - Error bar wrapper."""
    x = np.arange(1, 6)
