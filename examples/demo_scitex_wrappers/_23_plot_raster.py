...
"""ax.plot_raster(spike_times_list) - Raster/spike plot."""
...
def demo_plot_raster(fig, ax, stx):
    ...
    ax.plot_raster(spike_times_list, id="raster")

    ax.set_xyt(x="Time [s]", y="Trial", t="ax.plot_raster(spike_times_list)")
