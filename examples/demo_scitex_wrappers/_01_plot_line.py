...
"""ax.plot_line(values_1d) - Simple line plot wrapper."""
...
def demo_plot_line(fig, ax, stx):
    ...
    ax.plot_line(values_1d, id="line", label="Signal")

    ax.set_xyt(x="Sample", y="Amplitude [a.u.]", t="ax.plot_line(values_1d)")
    ax.legend()
