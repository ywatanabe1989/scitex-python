...
FigureType = Literal[
    ...
    "complex",
    # stx_* (25 plotters)
    "stx_line", "stx_mean_std", "stx_mean_ci", "stx_median_iqr",
    "stx_shaded_line", "stx_box", "stx_violin", "stx_scatter",
    "stx_bar", "stx_barh", "stx_errorbar", "stx_fill_between",
    "stx_kde", "stx_ecdf", "stx_heatmap", "stx_image", "stx_imshow",
    "stx_contour", "stx_raster", "stx_conf_mat", "stx_joyplot",
    "stx_rectangle", "stx_fillv", "stx_boxplot", "stx_violinplot",
    # sns_* (10 plotters)
    "sns_boxplot", "sns_violinplot", "sns_barplot", "sns_histplot",
    "sns_kdeplot", "sns_scatterplot", "sns_lineplot", "sns_swarmplot",
    "sns_stripplot", "sns_heatmap",
    # mpl_* (26 plotters)
    "mpl_plot", "mpl_scatter", "mpl_bar", "mpl_barh", "mpl_hist",
    "mpl_hist2d", "mpl_hexbin", "mpl_boxplot", "mpl_violinplot",
    "mpl_errorbar", "mpl_step", "mpl_stem", "mpl_fill",
    "mpl_fill_between", "mpl_stackplot", "mpl_contour", "mpl_contourf",
    "mpl_imshow", "mpl_pcolormesh", "mpl_pie", "mpl_eventplot",
    "mpl_quiver", "mpl_axhline", "mpl_axvline", "mpl_axhspan", "mpl_axvspan",
]
...
def create_complex_figure(output_dir: Path, plt, rng, COLORS) -> Path:
    ...
    ax_a2 = ax_a.twinx()
    ax_a2.plot(x, y2, color=COLORS.orange, label="exp(x/5)", linewidth=2, linestyle="--")
    ...
    sc = ax_b.scatter(x_scatter, y_scatter, c=colors, s=sizes, cmap="viridis", alpha=0.7)
    ...
    bars = ax_d.bar(categories, values, yerr=errors, capsize=5, color=bar_colors, edgecolor=COLORS.black)
    ...
    for i, (name, offset) in enumerate([("Alpha", 0), ("Beta", 1), ("Gamma", 2)]):
        ...
        ax_e.fill_between(x_line, y_mean - y_std, y_mean + y_std, alpha=0.3, color=line_colors[i])
    ...
    data_violin = [rng.normal(0, 1, 50), rng.normal(1, 1.5, 50), rng.normal(-0.5, 0.8, 50)]
