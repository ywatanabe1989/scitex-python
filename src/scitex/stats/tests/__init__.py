...
from .__corr_test_multi import corr_test, corr_test_pearson, corr_test_spearman
from .__corr_test_single import corr_test, corr_test_pearson, corr_test_spearman
