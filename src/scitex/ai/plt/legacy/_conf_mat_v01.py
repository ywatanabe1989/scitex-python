...
# File: /home/ywatanabe/proj/scitex_repo/src/scitex/ml/plt/legacy/_conf_mat_v01.py
# ----------------------------------------
...
"""Functions & Classes"""
def main(args):
    """Demo confusion matrix plotting (legacy v01)."""
    import scitex
    import numpy as np
    import sklearn
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description='Demo legacy v01 confusion matrix plotting')
