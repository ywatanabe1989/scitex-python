#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-10-10 03:28:14 (ywatanabe)"
...
async def log_page_async(
    ...
    """
    # Log to terminal with appropriate level
...
"""
                ...
                logger.warn(
                    f"    Screenshot failed: {screenshot_filename}\n{e}"
                )
...
class BrowserLogger:
    ...
    async def info(
        ...
        return await self._log(
            "info", page, message, duration_ms, take_screenshot, screenshot_dir
        )
    ...
    async def fail(
        ...
        return await self._log(
            "fail", page, message, duration_ms, take_screenshot, screenshot_dir
        )
