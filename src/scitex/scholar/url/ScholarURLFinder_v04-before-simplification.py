#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-10-10 22:27:37 (ywatanabe)"
...
class ScholarURLFinder:
    ...
    # ==========================================================================
    # PDF Finding Strategies - CLEANED UP!
    # ==========================================================================
    ...
    def update_metadata(self, metadata_path: Path, urls: Dict) -> bool:
        """Update metadata file with URLs."""
        try:
            metadata = (
            ...
            logger.success(f"{self.name}: Updated {metadata_path.parent.name}")
            return True
        except Exception as e:
    ...
    def get_urls_from_metadata(self, metadata_path: Path) -> Dict:
        ...
        try:
            return json.loads(metadata_path.read_text()).get("urls", {})
        except Exception as e:
