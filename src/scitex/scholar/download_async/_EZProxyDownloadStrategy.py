...
"""
EZProxy-based download_async strategy for PDFs.

This strategy uses EZProxy authentication to download_async PDFs
...
class EZProxyDownloadStrategy(BaseDownloadStrategy):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        Initialize EZProxy download_async strategy.
