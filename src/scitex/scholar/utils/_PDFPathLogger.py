...
class PDFPathLogger:
    ...
    def log_detection_result(self, 
        ...
        for i, pdf_url in enumerate(pdf_urls):
            ...
            downloaded = download_status[i] if i < len(download_status) else False
        ...
        entry = {
            ...
            "downloaded_count": sum(entry["downloaded"] for entry in pdf_entries),
    ...
    def _save_csv(self):
        ...
        with open(self.csv_log, 'w', newline='') as f:
            ...
            writer.writerow([
                ...
                'supplementary_count', 'total_pdfs', 'downloaded_count', 'total_size_mb',
