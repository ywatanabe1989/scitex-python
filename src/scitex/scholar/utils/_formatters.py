#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-08-09 01:12:09 (ywatanabe)"
# File: /home/ywatanabe/proj/SciTeX-Code/src/scitex/scholar/utils/_formatters.py
# ----------------------------------------
...
def papers_to_bibtex(
    papers: List[Paper], include_enriched: bool = True, add_header: bool = True
) -> str:
    """
...
def papers_to_json(
    papers: List[Paper], indent: int = 2, include_metadata: bool = True
) -> str:
    """
    ...
    """
    data = {"papers": [paper.to_dict() for paper in papers]}
...
def papers_to_markdown(
    papers: List[Paper], group_by: Optional[str] = None
) -> str:
    """
...
def validate_arxiv_id(arxiv_id: str) -> bool:
    ...
    return bool(
        re.match(new_pattern, arxiv_id) or re.match(old_pattern, arxiv_id)
    )
...
def merge_papers(
    papers_list: List[List[Paper]], deduplicate: bool = True
) -> List[Paper]:
    """
...
def filter_papers_by_regex(
    papers: List[Paper], pattern: str, fields: List[str] = None
) -> List[Paper]:
    """
