...
class CamaraBrasileiraDoLivroISBNTranslator:
    ...
    async def do_search(self, items: List[Dict[str, Any]], request_json_func) -> List[Dict[str, Any]]:
        """
    ...
    def _translate_result(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Language
        language = result.get('IdiomasObra', [''])[0] if result.get('IdiomasObra') else 'pt-BR'
    ...
    def _clean_data(self, items: Any) -> List[Dict[str, Any]]:
        ...
        for item in items:
            ...
            if item.get('ISBN'):
                ...
                if (isbn.startswith('97865') or isbn.startswith('65') or
                    isbn.startswith('97885') or isbn.startswith('85')):
                    item['ISBN'] = isbn
                    result.append(item)
