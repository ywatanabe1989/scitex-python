...
class CanLIITranslator:
    ...
    CAN_LII_REGEXP = re.compile(r'https?://(?:www\.)?canlii\.org[^/]*/(?:en|fr)/[^/]+/[^/]+/doc/.+')
    ...
    def scrape(self, doc: BeautifulSoup, url: str) -> Dict[str, Any]:
        ...
        # Docket number
        docket_div = doc.find('div', string=re.compile(r'File number|Numéro de dossier'))
        if docket_div:
        ...
        # Other citations
        other_citations_div = doc.find('div', string=re.compile(r'Other citations|Autres citations'))
