#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-08-05 21:12:48 (ywatanabe)"
# File: /home/ywatanabe/proj/scitex_repo/src/scitex/scholar/auth/sso_automations/_UniversityOfMelbourneSSOAutomator_v01.py
# ----------------------------------------
from __future__ import annotations
import os
__FILE__ = (
    "./src/scitex/scholar/auth/sso_automations/_UniversityOfMelbourneSSOAutomator_v01.py"
)
...
class UniversityOfMelbourneSSOAutomator(BaseSSOAutomator):
    ...
    async def _handle_generic_login_async(self, page: Page) -> bool:
        ...
        try:
            ...
            if login_buttons:
                await page.evaluate(
                    "(element) => element.click()", login_buttons[0]
                )
...
# python -m scitex.scholar.auth.sso_automations._UniversityOfMelbourneSSOAutomator_v01
