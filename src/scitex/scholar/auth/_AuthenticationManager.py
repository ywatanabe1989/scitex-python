#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-07-26 14:05:00 (ywatanabe)"
# File: ./src/scitex/scholar/auth/_AuthenticationManager.py
# ----------------------------------------
import os
__FILE__ = (
...
class AuthenticationManager:
    ...
    def register_provider(
        ...
        Args:
            ...
            provider: Instance of an authentication provider
        """
        if not isinstance(provider, BaseAuthenticationProvider):
            raise TypeError(
                f"Provider must inherit from BaseAuthenticationProvider, "
                f"got {type(provider)}"
            )
    ...
    def get_active_provider(self) -> Optional[BaseAuthenticationProvider]:
        """
