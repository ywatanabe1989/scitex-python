#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-08-01 20:33:44 (ywatanabe)"
...
class ChromeExtensionManager:
    ...
    def _get_profile_path(self, profile_name: str) -> Path:
        ...
        return base_dir / "scholar" / "chrome_profiles" / profile_name
    ...
    async def check_extensions_installed(self) -> Dict[str, bool]:
        ...
        return {key: False for key in self.SCHOLAR_EXTENSIONS}
    ...
    async def install_extensions_interactive(self):
        ...
        print(f"\n⚠ Need to install ({len(self.SCHOLAR_EXTENSIONS)}):")
        for key, ext in self.SCHOLAR_EXTENSIONS.items():
        ...
        # Add extension URLs
        for key, ext_info in self.SCHOLAR_EXTENSIONS.items():
            ext_id = ext_info["id"]
    ...
    def reset_profile(self):
        ...
        if self.profile_dir.exists():
            ...
            logger.info(f"Chrome profile reset: {self.profile_name}")
        self._ensure_profile_directory()
