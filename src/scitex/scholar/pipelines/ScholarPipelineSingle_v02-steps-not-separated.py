#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-10-13 08:40:03 (ywatanabe)"
...
class ScholarPipelineSingle:
    ...
    def step1_normalize_as_doi(self, doi_or_title):
    ...
    async def step2_create_paper(self, doi, doi_or_title):
    ...
    def step3_add_paper_id(self, paper):
    ...
    async def process_single_paper(
        ...
        """
        # Step 1: Normalize input as DOI
        doi = self.step1_normalize_as_doi(doi_or_title)

        # Step 2: Create Paper and resolve DOI from title if needed
        paper = await self.step2_create_paper(doi, doi_or_title)

        # Step 3: Generate 8-digit library ID
        paper = self.step3_add_paper_id(paper)
