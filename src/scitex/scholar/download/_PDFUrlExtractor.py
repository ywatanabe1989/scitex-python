#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-08-08 00:30:00 (assistant)"
# File: /home/ywatanabe/proj/SciTeX-Code/src/scitex/scholar/download/_PDFUrlExtractor.py
# ----------------------------------------
from __future__ import annotations
import os
__FILE__ = (
    "./src/scitex/scholar/download/_PDFUrlExtractor.py"
)
...
class PDFUrlExtractor:
    ...
    def __init__(self, translators_dir: str = None):
        ...
        if translators_dir is None:
            translators_dir = Path(__DIR__) / "zotero_translators"
