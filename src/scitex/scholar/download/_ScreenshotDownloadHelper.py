...
class ScreenshotDownloadHelper:
        ...
        async with async_playwright() as p:
            ...
            for idx, url in enumerate(urls):
                try:
                    ...
                    if await self._check_for_login_async(page):
                        screenshot_path = await self._capture_screenshot_async(
                    ...
                    # Check for captcha
                    if await self._check_for_captcha_async(page):
                        screenshot_path = await self._capture_screenshot_async(
    ...
    async def _capture_screenshot_async(self, page: Page, storage_key: str, 
    ...
    async def _check_for_login_async(self, page: Page) -> bool:
    ...
    async def _check_for_captcha_async(self, page: Page) -> bool:
