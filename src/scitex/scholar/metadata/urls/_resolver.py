#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-08-08 01:12:00 (assistant)"
...
async def doi_to_url_publisher(doi: str, context: BrowserContext = None) -> Optional[str]:
    """
...
def generate_openurl_query(
    metadata: Dict,
    base_url: str = "https://unimelb.hosted.exlibrisgroup.com/openurl/61UNIMELB/61UNIMELB_INST"
) -> Optional[str]:
    """
    ...
    Args:
        ...
        base_url: Institution's OpenURL resolver base URL
