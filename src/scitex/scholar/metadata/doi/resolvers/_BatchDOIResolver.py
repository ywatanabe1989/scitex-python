#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-08-09 02:55:54 (ywatanabe)"
# File: /home/ywatanabe/proj/SciTeX-Code/src/scitex/scholar/metadata/doi/resolvers/_BatchDOIResolver.py
# ----------------------------------------
from __future__ import annotations
import os
__FILE__ = (
    "./src/scitex/scholar/metadata/doi/resolvers/_BatchDOIResolver.py"
)
...
class BatchDOIResolver:
    ...
    def __init__(
        ...
        self.max_worker_asyncs = self.config_manager.get_max_worker_asyncs(
            max_worker_asyncs
        )
