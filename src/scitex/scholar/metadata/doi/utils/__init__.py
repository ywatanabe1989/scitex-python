...
from .enhanced_doi_resolver import EnhancedSingleDOIResolver

__all__ = [
    "URLDOIExtractor",
    "PubMedConverter", 
    "TextNormalizer",
    "EnhancedSingleDOIResolver",
]
...
def create_doi_utilities(
    ...
    email: str = None,
    api_key: str = None
) -> tuple[URLDOIExtractor, PubMedConverter, TextNormalizer]:
    """
    ...
    Returns:
        Tuple of (URLDOIExtractor, PubMedConverter, TextNormalizer)
    """
    ...
    return url_extractor, pubmed_converter, text_normalizer
