#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-08-14 16:19:42 (ywatanabe)"
...
def to_complete_metadata_structure(metadata):
    ...
    for section_key, section_data in metadata.items():
        if section_key in BASE_STRUCTURE:
            if isinstance(BASE_STRUCTURE[section_key], dict):
                BASE_STRUCTURE[section_key].update(section_data)
            else:
                BASE_STRUCTURE[section_key] = section_data
