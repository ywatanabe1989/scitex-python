#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-07-19 13:15:00 (ywatanabe)"
# File: ./src/scitex/scholar/_pdf_extractor.py
# ----------------------------------------
import os
__FILE__ = (
    "./src/scitex/scholar/_pdf_extractor.py"
)
...
class PDFExtractor:
    ...
    def _parse_sections(self, pages_text: List[Tuple[int, str]]) -> Dict[str, str]:
