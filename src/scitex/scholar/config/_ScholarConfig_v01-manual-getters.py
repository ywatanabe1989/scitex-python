#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-08-12 12:27:25 (ywatanabe)"
...
class ScholarConfig:
    ...
    def get_library_info_dir(
        self,
    ) -> Path:
        return self.path_manager.get_library_info_dir()

    def get_library_master_dir(self) -> Path:
        """Get the MASTER directory for internal storage."""
        return self.path_manager.get_library_master_dir()
