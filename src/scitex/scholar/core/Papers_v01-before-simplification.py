...
class Papers:
    ...
    def _bibtex_entry_to_paper(entry: Dict[str, Any]) -> Optional[Paper]:
        ...
        try:
            ...
            # Create Paper object with properly structured data
            basic_data = {
                "title": title,
                "authors": authors,
            ...
            if "citation_count" in fields:
                try:
                    if hasattr(paper, 'citation_count'):
                        paper.citation_count.count = int(fields["citation_count"])
            ...
            # Note: volume, pages, url are already handled in publication_data and url_data above
