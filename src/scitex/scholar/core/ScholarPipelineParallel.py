#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-10-11 21:49:36 (ywatanabe)"
# File: /home/ywatanabe/proj/scitex_repo/src/scitex/scholar/core/ScholarPipelineParallel.py
# ----------------------------------------
from __future__ import annotations
import os
__FILE__ = (
    "./src/scitex/scholar/core/ScholarPipelineParallel.py"
)
...
from scitex.scholar.core.ScholarPipelineSingle import ScholarPipelineSingle
...
class ScholarPipelineParallel:
    ...
    def _prepare_worker_profiles(self, num_workers: int = None) -> List[str]:
        ...
        """
        workers_to_prepare = num_workers if num_workers is not None else self.num_workers
...
Usage:
    # With DOIs (4 workers)
    python -m scitex.scholar.core.ScholarPipelineParallel \
