#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-10-11 22:05:08 (ywatanabe)"
# File: /home/ywatanabe/proj/scitex_repo/src/scitex/scholar/core/ScholarPipelineSingle.py
# ----------------------------------------
from __future__ import annotations
import os
__FILE__ = (
    "./src/scitex/scholar/core/ScholarPipelineSingle.py"
)
...
def main(args):
    ...
    orchestrator = ScholarPipelineSingle(
...
Usage:
    # With DOI
    python -m scitex.scholar.core.ScholarPipelineSingle \
