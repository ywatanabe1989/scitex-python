#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-08-07 15:37:34 (ywatanabe)"
# File: /home/ywatanabe/proj/scitex_repo/src/scitex/scholar/metadata/enrichment/_MetadataEnricher.py
# ----------------------------------------
from __future__ import annotations
import os
__FILE__ = (
    "./src/scitex/scholar/metadata/enrichment/_MetadataEnricher.py"
)
...
from scitex.errors import EnrichmentError, warn_performance
...
class MetadataEnricher:
    ...
    def __init__(
        ...
        # Handle API keys
        self.semantic_scholar_api_key = config.resolve(
            "semantic_scholar_api_key", semantic_scholar_api_key, default=None
        )
        self.crossref_api_key = config.resolve(
            "crossref_api_key", crossref_api_key, default=None
        )
        ...
        self.email_crossref = config.resolve(
            "email_crossref", email_crossref, default=""
        )
        self.email_pubmed = config.resolve(
            "email_pubmed", email_pubmed, default=""
        )
        self.email_openalex = config.resolve(
            "email_openalex", email_openalex, default=""
        )
        self.email_semantic_scholar = config.resolve(
            "email_semantic_scholar", email_semantic_scholar, default=""
        )
        ...
        self._pipeline = EnricherPipeline(
            email_crossref=self.email_crossref,
            email_pubmed=self.email_pubmed,
            email_openalex=self.email_openalex,
            email_semantic_scholar=self.email_semantic_scholar,
