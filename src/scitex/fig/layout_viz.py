...
# File: /home/ywatanabe/proj/scitex-code/src/scitex/fig/layout_viz.py

"""Blueprint-style visualization for .stx layout and coordinate system.
...
Usage:
    from scitex.fig.layout_viz import plot_layout, plot_auto_crop_comparison
...
from .layout import element_bounds, normalize_size
