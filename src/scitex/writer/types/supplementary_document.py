...
class SupplementaryContents:
    ...
    def __post_init__(self):
        ...
        if self.journal_name is None:
            self.journal_name = DocumentSection(self.root / "journal_name.tex", self.git_root)
        if self.figures is None:
            self.figures = self.root / "figures"
        if self.tables is None:
            self.tables = self.root / "tables"
        if self.bibliography is None:
            self.bibliography = DocumentSection(self.root / "bibliography.bib", self.git_root)
...
class SupplementaryDocument:
    ...
    def __post_init__(self):
        ...
        if self.contents is None:
            self.contents = SupplementaryContents(self.dir / "contents", self.git_root)
        ...
        if self.supplementary is None:
            self.supplementary = DocumentSection(self.dir / "supplementary.tex", self.git_root)
        ...
        if self.readme is None:
            self.readme = DocumentSection(self.dir / "README.md", self.git_root)
